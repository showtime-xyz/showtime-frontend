		...
		<>
			{isOpen && (
				<ClientOnlyPortal selector="#modal">
					...
					>
						<div
							className="fixed z-2 shadow-lg bg-white absolute top-[10%] inset-x-[5%] p-4 mx-auto max-h-[80vh] max-w-[400px] flex flex-col rounded-lg sm:rounded-2xl text-black"
