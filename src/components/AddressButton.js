...
const AddressButton = ({ address, ens_domain, isCollection = false }) => {
	...
	return (
		<span className={`border dark:border-gray-700 rounded-full px-3 py-1 text-sm flex items-center justify-between space-x-2 text-gray-800 dark:text-white ${isCollection ? 'flex-1' : ''}`}>
