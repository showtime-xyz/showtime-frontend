								...
								<div className="flex-grow ">
									<div className="flex flex-row mt-8">
										<a
											...
											rel="noreferrer"
										>
											<div className="text-base px-5 py-2 shadow-md transition-all rounded-full text-white bg-stpink hover:bg-white hover:text-stpink border-2 border-stpink">{`Bid on ${getContractName(
												item
											)}`}</div>
										</a>
