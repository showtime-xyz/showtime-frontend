...
const IpfsUpload = ({ ipfsHash, onChange = () => null, onCancel = () => null, fileDetails, isUploading }) => {
	return (
			...
			{ipfsHash ? (
				<>
					<div className="space-x-1.5 flex items-center dark:text-gray-300">
						...
						<button onClick={onCancel} className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white rounded-full p-1.5 -my-1 focus-visible:ring">
				...
				<div className="flex items-center space-x-4">
					...
					<button onClick={onCancel} className="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-white rounded-full p-2.5 focus-visible:ring">
						<XIcon className="w-5 h-5" />
					</button>
				</div>
			) : (
