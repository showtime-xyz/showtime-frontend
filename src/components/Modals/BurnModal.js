...
const BurnModal = ({ open, onClose, token }) => {
	...
	const burnToken = async () => {
		...
		const { data } = await contract.populateTransaction.burn(signerAddress, 2 /* token.token_id */, quantity)
	...
	return (
		<div tabIndex="0" className="focus:outline-none p-12 space-y-8 flex-1 flex flex-col items-center justify-center">
			...
			<div className="space-y-1">
				<p className="font-medium text-gray-900 dark:text-white text-center">Preparing to burn your NFT...</p>
