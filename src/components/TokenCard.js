	...
	return (
		<>
			<div className="px-0 sm:px-3 mb-6 sm:mb-0">
				<div style={item.user_hidden ? { opacity: 0.7, backgroundColor: '#ddd' } : null} ref={divRef} className="mx-auto sm:rounded-xl overflow-hidden shadow-md hover:shadow-lg transition-all bg-white">
