				...
				<CappedWidth>
					<div className="flex flex-row items-center justify-between px-2 md:px-3 space-x-5">
						...
						<div className="hidden flex-1 md:flex mr-6 items-center font-normal space-x-4">
							<Link href="/">
								<a className={`text-black dark:text-gray-200 text-sm md:text-base flex items-center space-x-2 ${asPath == '/' ? 'bg-black dark:bg-white bg-opacity-10 dark:bg-opacity-10 backdrop-filter backdrop-blur-lg backdrop-saturate-150' : 'hover:bg-black dark:hover:bg-white hover:bg-opacity-10 dark:hover:bg-opacity-10 hover:backdrop-filter hover:backdrop-blur-lg hover:backdrop-saturate-150'} rounded-full py-1 px-2`} onClick={() => mixpanel.track('Discover button click')}>
