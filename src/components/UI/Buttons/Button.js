...
export const TertiaryButton = ({ className, ...props }) => <BaseButton {...props} className={`relative border bg-transparent border-gray-500 dark:border-gray-300 rounded-2xl flex items-center px-4 py-2 ${className}`} />
