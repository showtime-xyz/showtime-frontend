...
import { HomeTabBarIcon, DiscoverTabBarIcon, TrendingTabBarIcon, NotificationsTabBarIcon } from './tab-bar-icons'
...
export function NextTabNavigator({ pageProps, Component }: NextNavigationProps) {
