...
config.MESSAGE_TO_SIGN =
  "Sign message to prove the ownership of your account with counter ";
config.WITHDRAW_MESSAGE_TO_SIGN =
  "Provide your signature to withdraw funds with counter ";
config.USER_ACCOUNT = "BUA";
config.USER_CONTRACT = "BUC";
config.JSON_RPC_VERSION = "2.0";
config.LOGIN_MESSAGE_TO_SIGN =
  "Sign message to login to Biconomy with counter ";
