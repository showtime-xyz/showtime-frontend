...
const DEFAULT_WIDTH = Platform.select({
  web: "w-10/12 max-w-480px md:w-480px lg:w-480px",
...
const MODAL_TW_BASE = "flex overflow-hidden bg-white dark:bg-black shadow-lg shadow-black dark:shadow-white"
const MODAL_TW = Platform.select({
  web: `${MODAL_TW_BASE} rounded-[32px]`,
  default: `${MODAL_TW_BASE} rounded-t-[32px]`
})
