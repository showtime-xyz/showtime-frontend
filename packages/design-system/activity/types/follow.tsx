				...
				{count === 1 && (
					<>
						...
						<TextLink
							...
							href={`/${counterparties[0]?.username || counterparties[0]?.wallet_address}`}
						>
				...
				{count === 2 && (
					<>
						...
						<TextLink
							variant="text-sm"
							tw="text-black dark:text-white font-bold"
							href={`/${counterparties[1]?.username || counterparties[1]?.wallet_address}`}
						>
				...
				{count === 3 && (
					<>
						...
						<TextLink
							variant="text-sm"
							tw="text-black dark:text-white font-bold"
							href={`/${counterparties[2]?.username || counterparties[2]?.wallet_address}`}
						>
