...
export const Icons: React.VFC<{}> = () => {
	return (
		<View tw="flex-row">
			<Liked width={20} height={20} color="white" />
			<View tw="w-2" />
			<Commented width={20} height={20} color="white" />
			<View tw="w-2" />
			<Transfer width={20} height={20} color="white" />
			<View tw="w-2" />
			<Purchased width={20} height={20} color="white" />
			<View tw="w-2" />
			<Followed width={20} height={20} color="white" />
		</View>
	)
}
...
export const Primary: React.VFC<{}> = () => {
	const activity = {
		...
		nfts: [
			{
				...
				token_img_original_url: 'https://ipfs.io/ipfs/QmS3bHrWy58Gz5FMDmhgCQxiiAJ6Ct5MoQxhj2KRgFDkok',
				token_has_video: 0,
				...
				creator_img_url: 'https://storage.googleapis.com/nft-public-profile-pics/147991_1619920081.jpg',
				multiple_owners: 1,
				owner_id: null,
				owner_name: null,
				owner_address: null,
		...
		actor: {
			...
			img_url: 'https://storage.googleapis.com/nft-public-profile-pics/147991_1619920081.jpg',
		},
	}
