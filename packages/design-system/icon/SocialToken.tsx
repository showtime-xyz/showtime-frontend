...
import Svg, { SvgProps, G, Path, Rect, Defs, LinearGradient, Stop, ClipPath } from 'react-native-svg'
	...
	return (
		<Svg width="1em" height="1em" viewBox="0 0 24 24" fill="none" {...props}>
			<G clipPath="url(#Social_Token_svg__clip0_752:19)">
				...
				<Path fill="#FCD34D" d="M-4.856 14.804l27.713-16 1.5 2.598-27.713 16z" />
				<G>
					<Rect x={4} y={4} width={16} height={16} rx={8} fill="#FBBF24" fillOpacity={0.6} />
					<Rect
						x={4.5}
						y={4.5}
						width={15}
