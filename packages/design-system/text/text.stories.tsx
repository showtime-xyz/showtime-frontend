...
export const TextXS: React.VFC<{}> = () => (
  <Text tw="text-xs text-black dark:text-white">Hello World, my man!</Text>
);
...
export const TextSM: React.VFC<{}> = () => (
  <Text tw="text-sm text-black dark:text-white">Hello World, my man!</Text>
);
...
export const TextBase: React.VFC<{}> = () => (
  <Text tw="text-base text-black dark:text-white">Hello World, my man!</Text>
);
...
export const TextXL: React.VFC<{}> = () => (
  <Text tw="text-xl text-black dark:text-white">Hello World, my man!</Text>
);
...
export const Text3XL: React.VFC<{}> = () => (
  <Text tw="text-3xl text-black dark:text-white">Hello World, my man!</Text>
);
...
export const Text4XL: React.VFC<{}> = () => (
  <Text tw="text-4xl text-black dark:text-white">Hello World, my man!</Text>
);
