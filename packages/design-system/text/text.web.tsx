...
export const Text = forwardRef<TextType, TextProps>(({ onLayout, accessibilityRole, ...props }, ref) => {
	...
	if (accessibilityRole === 'label') {
		...
		return <DripsyText onLayout={onLayout} accessibilityRole={accessibilityRole} {...props} ref={ref} />
	}
})
