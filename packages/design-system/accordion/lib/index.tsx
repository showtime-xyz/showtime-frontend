...
const Item = ({ disabled, value, ...props }: ItemProps) => {
	return <ItemContext.Provider value={{ value, disabled }}>{props.children}</ItemContext.Provider>
}
...
const Content = (props: ContentProps) => {
	...
	return <AnimateHeight hide={itemValue !== selectedValue}>{props.children}</AnimateHeight>
}
