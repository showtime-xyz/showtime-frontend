		...
		<View>
			...
			{showTokenIcon ? (
				<View style={styles.wrapper}>
					<View style={[styles.semiCircle, tw.style('border-white dark:border-black')]}></View>
					<Image source={require('../../../apps/expo/assets/social_token.png')} style={styles.socialToken} />
				</View>
			) : null}
		</View>
	)
