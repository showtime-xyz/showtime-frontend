...
import { Image as ReactNativeImage, ImageProps as ReactNativeImageProps, Platform } from 'react-native'
...
type ImageProps = { tw?: string; alt?: string; blurhash?: string } & ComponentProps<typeof Img>
...
function StyledImage({ tw, style, blurhash, ...props }: ImageProps) {
	...
	return <Img style={[style, tailwind.style(tw)]} width={width} height={height} {...props} />
}
