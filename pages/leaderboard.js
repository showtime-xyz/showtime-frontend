    ...
    return (
        <Layout>
            <Head>
                ...
                <meta name="description" content="Nice people making cool stuff" />
                <meta property="og:type" content="website" />
                <meta
                    name="og:description"
                    content="Nice people making cool stuff"
                />
            ...
            {columns && (
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-7xl xl:text-8xl" style={{ fontFamily: "Afronaut" }}>{"cool stuff."}</h1>
                </div>
            )}
                ...
                <Content>
                    {isLoading
                        ...
                        : leaderboardItems.map(
                            (item, index) => <LeaderboardItem key={index} item={item} />
                        )}
                </Content>
            </div>
        </Layout>
