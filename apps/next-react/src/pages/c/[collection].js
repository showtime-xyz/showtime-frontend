...
export default function Collection({
  ...
  useEffect(() => {
    ...
    const selectedValue = collection_list.filter(
      (c) => c.value == router.query.collection
    )[0];
    ...
    if (router.query.collection == "all") {
      ...
      setPageTitle(
        selectedValue
          ? selectedValue.name
          : router.query.collection.replace(/-/g, " ")
      );
        ...
        <CappedWidth>
          <div className="flex flex-row mx-3 text-white">
            <div className="flex-1">
              <div className="text-xl sm:text-2xl dark:text-black">
                Discover
              </div>
      ...
      <CappedWidth>
        <div className=" flex-1 -mt-4 mx-3 lg:w-2/3 lg:pr-6 xl:w-1/2 ">
          <div className="border border-transparent dark:border-gray-800 bg-white dark:bg-gray-900 rounded-lg shadow-md px-6 py-6 text-center flex flex-col md:flex-row items-center">
            <div className="flex-1 mb-3 md:mb-0 dark:text-gray-300">
        ...
        <div className="mx-auto relative mt-12 overflow-hidden">
          {FilterTabs}
        </div>
