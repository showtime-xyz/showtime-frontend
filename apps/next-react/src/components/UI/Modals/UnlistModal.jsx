      ...
      <div className="flex-1 overflow-y-auto">
        ...
        {token && (
          <>
            ...
            <div
              className={`p-4 border-b border-gray-100 dark:border-gray-900 flex items-center ${
                hasMultipleEditions ? "justify-between" : "justify-end"
              }`}
            >
              {hasMultipleEditions && (
                <p className="text-gray-600 text-xs font-semibold dark:text-white">
                  {currentListing.quantity} listed
                </p>
              )}
              <p className="text-gray-600 text-xs font-semibold dark:text-white">
