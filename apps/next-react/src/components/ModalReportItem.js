								...
								<>
									<div className="my-8">
										<textarea
											...
											type="text"
											maxLength="200"
											className="w-full text-black dark:text-gray-300 p-3 rounded-lg border-2 border-gray-400 dark:border-gray-800 focus:outline-none focus:border-gray-500 dark:focus:border-gray-600"
											rows={4}
										/>
									</div>
