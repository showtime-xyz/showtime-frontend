...
const SearchBar = ({ propagateSearchState }) => {
  ...
  const [isMobileSearchOverlayOpen, toggleMobileSearchOverlay] =
    useState(false);
  const [searchText, setSearchText] = useState("");
  const [activeSelectedSearchResult, setActiveSelectedSearchResult] =
    useState(null);
    ...
    <>
      ...
      <div
        className={`flex md:hidden ${
          isMobileSearchOverlayOpen ? "hidden" : ""
        }`}
      >
        <button
