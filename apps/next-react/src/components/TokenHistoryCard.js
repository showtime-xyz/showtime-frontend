						...
						<tbody>
							{nftHistory.history.length == 1 && !nftHistory.history[0].from_address ? null : (
								<tr className="text-left text-gray-400 text-sm">
									...
									{nftHistory.multiple && (
										<td className="truncate px-2 py-4 w-[fit-content] text-right">Qty</td>
									)}
										...
										className={`truncate py-3 px-4 ${
											!entry.from_address
												? `border-t-2 border-gray-100 dark:border-gray-800 rounded-bl-xl ${
														nftHistory.history.length == 1 ? 'rounded-tl-xl' : null
												  }`
												: ''
										}`}
									>
										...
										className={`truncate py-3 px-4 dark:text-gray-500 ${
											!entry.from_address
												? `border-t-2 border-gray-100 dark:border-gray-800 rounded-br-xl ${
														nftHistory.history.length == 1 ? 'rounded-tr-xl' : null
												  }`
												: ''
										}`}
									>
