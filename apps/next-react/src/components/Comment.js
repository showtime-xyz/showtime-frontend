      ...
      <div className="flex flex-col flex-1">
        <div className="flex items-center justify-between">
          <div className="flex flex-col sm:flex-row">
            ...
            >
              <a
                className="dark:text-gray-300 hover:text-stpink dark:hover:text-stpink cursor-pointer text-sm truncate"
                onClick={closeModal}
              >
          ...
          <div
            className={`text-gray-400 dark:text-gray-500 text-xs flex-0 sm:mb-0 ${
          ...
          {(isOwnerOfNFT || userWroteComment || isCreatorOfNFT) && (
            ...
            >
              <div
                ...
                className="ml-3 mr-1 cursor-pointer text-gray-400 dark:text-gray-600 hover:text-gray-600 dark:hover:text-gray-500 transition"
              >
                <DotsHorizontalIcon className="w-5 h-5" />
              </div>
              <div
                ref={dropdownRef}
                className={`absolute text-center top-6 right-0 border border-transparent dark:border-gray-800 bg-white dark:bg-gray-900 py-2 px-2 shadow-lg rounded-xl transition-all text-sm transform z-1 ${
                  isActive
        ...
        <div className="flex justify-end">
          <div className="flex items-center">
            <div
              ...
              className="flex items-center justify-end text-gray-400 text-xs sm:mb-0 cursor-pointer mr-2"
            >
            ...
            <CommentLikeButton
              comment={comment}
              openLikedByModal={openLikedByModal}
            />
          </div>
        </div>
      </div>
